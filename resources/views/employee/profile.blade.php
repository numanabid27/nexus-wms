            ...
            <div class="col-xl-3 col-sm-6">
                <div class="card border card-border-success">
                    <div class="card-body">
                        ...
                        <h4 class="mb-3"><span class="counter-value" data-target="{{ $employees }}">{{ $employees }}</span> </h4>
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="card border card-border-primary">
                    <div class="card-body">
                        ...
                        <h4 class="mb-3"><span class="counter-value" data-target="{{ $locations }}">{{ $locations }}</span> </h4>
                    </div>
                </div>
            </div>
            <!--end col-->
