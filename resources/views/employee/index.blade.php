...
@section('page-title')
    <x-breadcrumb pagetitle="{{ __('employees') }}" title="" />
@endsection

@section('page-button')
<a class="btn btn-info" href="{{ route('employee.create') }}">
    <i class="ph ph-user me-1 align-middle"></i> {{ __('create_new_employee') }}
</a>
@endsection
                                ...
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a href="{{ route('employee.show',$user->id) }}" class="dropdown-item">
                                                    <i class="ri-eye-fill align-bottom me-2 text-muted"></i> {{ __('view') }}
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item edit-item-btn" href="{{ route('employee.edit',$user->id) }}">
                                            ...
                                            <li>
                                                ...
                                                @if($user->is_deleted != 1)
                                                <form method="POST" action="{{ route('employee.destroy',$user->id) }}" style="display:inline;">
                                                ...
                                                @else
                                                <form method="GET" action="{{ route('employee.active',$user->id) }}" style="display:inline;">
                                                    <button class="dropdown-item edit-item-btn" type="button"  onclick="sa_warning_delete_form_submit(this,'Are you sure?','Are you sure you want to activate this employee?','Yes, activate it!')">
