...
@section('page-title')
  <x-breadcrumb pagetitle="{{ __('customer') }}" title="{{ __('create') }}" />
@endsection
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                {!! Form::open(array('route' => 'customer.store','method'=>'POST', 'class' => 'row g-3 needs-validation' , 'novalidate', 'enctype'=>"multipart/form-data")) !!}
                    ...
                    <div class="col-md-12">
                        ...
                        {!! Form::text('client_id', null, array('placeholder' => __('client_id'),'class' => 'form-control', 'required')) !!}
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-12">
                        ...
                        {!! Form::text('tax_registration_number', null, array('placeholder' => __('tax_registration_number'),'class' => 'form-control')) !!}
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-4">
                        ...
                        {!! Form::text('phone_no', null, array('placeholder' => __('phone_no'),'class' => 'form-control', 'required')) !!}
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-4">
                        ...
                        {!! Form::email('email', null, array('placeholder' => __('email'),'class' => 'form-control', 'required')) !!}
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-12">
                        ...
                        {!! Form::text('po_number', null, array('placeholder' => __('po_number'),'class' => 'form-control')) !!}
                        <div class="invalid-feedback">
                            Please provide {{ __('po_number') }}
                        </div>
                    </div>
                    <div class="col-md-12">
                        <label for="validationCustom01" class="form-label">{{ __('address') }}:</label>
                        {!! Form::textarea('address', null, array('placeholder' => __('address'),'class' => 'form-control', 'required','rows' => 4, )) !!}
                        <div class="invalid-feedback">
                            Please provide {{ __('address') }}
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group has-validation">
                            <select class="form-control" name="billing_model">
                                <option value="1">{{ __('contract') }}</option>
                                <option value="2">{{ __('per_lift') }}</option>
                            </select>
                            <div class="invalid-feedback">
                                Please provide {{ __('billing_model') }}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="input-group has-validation">
                            <select class="form-control" name="schedule">
                                <option value="1">{{ __('daily_7') }}</option>
                                <option value="2">{{ __('daily_6') }}</option>
                                <option value="3">{{ __('3_days_week') }}</option>
                                <option value="4">{{ __('2_days_week') }}</option>
                                <option value="5">{{ __('twice_daily') }}</option>
                                <option value="6">{{ __('on_call') }}</option>
                            </select>
                            <div class="invalid-feedback">
                                Please provide {{ __('schedule') }}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="input-group has-validation">
                            <select class="form-control" name="skip_provided">
                                <option value="1" selected>{{ __('owned') }}</option>
                                <option value="2">{{ __('client') }}</option>
                                
                            </select>
                            <div class="invalid-feedback">
                                Please provide {{ __('skip_provided') }}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <label for="validationCustom01" class="form-label">{{ __('gate_fee') }}:</label>
                        {!! Form::text('gate_fee', null, array('placeholder' => __('gate_fee'),'class' => 'form-control')) !!}
                        <div class="invalid-feedback">
                    ...
                    <div class="accordion custom-accordionwithicon custom-accordion-border accordion-border-box accordion-success" id="accordionFill">
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="accordionFillInner1">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#accor_fill1" aria-expanded="true" aria-controls="accor_fill1">
                                    ...
                                    <div class="col-md-auto ms-auto">
                                        <span type="button" class="btn btn-outline-danger btn-icon btn_remove_location_count"><i class="ri-delete-bin-line"></i></span>
                                    </div>
                                </button>
                            </h2>
                            <div id="accor_fill1" class="accordion-collapse collapse show" aria-labelledby="accordionFillInner1" data-bs-parent="#accordionFill">
                                <div class="accordion-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label for="validationCustom01" class="form-label">{{ __('location_name') }}:</label>
                                            {!! Form::text('location_name[]', null, array('placeholder' => __('location_name'),'class' => 'form-control', 'required')) !!}
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            {!! Form::text('tag_uid[]', null, array('placeholder' => __('tag_id'),'class' => 'form-control', 'required')) !!}
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            {!! Form::textarea('skip_location[]', null, array('placeholder' => __('skip_location'),'class' => 'form-control', 'required','rows' => 4, )) !!}
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="my-2 skip_row_parent">
                                            <div class="row skip_count_row my-1">
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="input-group has-validation">
                                                        <select class="form-control waste_type" name="waste_type[0][]" required>
                                                            <option value="">{{ __('select_value') }}</option>
                                                            <option value="1">{{ __('general') }}</option>
                                                            <option value="2">{{ __('construction') }}</option>
                                                            <option value="3">{{ __('hazardous') }}</option>
                                                            <option value="4">{{ __('msw') }}</option>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="input-group has-validation">
                                                        <select class="form-control skip_size" name="skip_size[0][]" required>
                                                            <option value="">{{ __('select_value') }}</option>
                                                            @foreach($skips as $val)
                                                            <option value="{{ $val->skip_size }}" _price="{{ $val->skip_price }}" _municipality_fee="{{ $val->municipality_fee }}">{{ $val->skip_size }}</option>
                                                            @endforeach
                                                        </select>
                                                        <div class="invalid-feedback">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    {!! Form::text('skip_price[0][]', null, array('placeholder' => __('skip_price'),'class' => 'form-control skip_price', 'required' )) !!}
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    {!! Form::text('municipality_fee[0][]', null, array('placeholder' => __('municipality_fee'),'class' => 'form-control municipality_fee', 'required' )) !!}
                                                    <div class="invalid-feedback">
