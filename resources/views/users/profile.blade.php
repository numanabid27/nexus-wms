            ...
            <div class="col-xl-3 col-sm-6">
                <div class="card border card-border-success">
                    <div class="card-body">
                        ...
                        <p class="fs-md text-muted mb-4">Total Helpers</p>
                        <h4 class="mb-3"><span class="counter-value" data-target="{{ $helpers }}">{{ $helpers }}</span> </h4>
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="card border card-border-primary">
                    <div class="card-body">
                        ...
                        <p class="fs-md text-muted mb-4">Total Drivers</p>
                        <h4 class="mb-3"><span class="counter-value" data-target="{{ $drivers }}">{{ $drivers }}</span> </h4>
                    </div>
                </div>
            </div>
            <!--end col-->
            <div class="col-xl-3 col-sm-6">
                <div class="card border card-border-primary">
                    <div class="card-body">
                        ...
                        <p class="fs-md text-muted mb-4">Total Customers</p>
                        <h4 class="mb-3"><span class="counter-value" data-target="{{ $customers }}">{{ $customers }}</span> </h4>
                    </div>
                </div>
            </div>
            <!--end col-->
