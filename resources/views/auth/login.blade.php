                            ...
                            <div class="col-xxl-5">
                                <div
                                    ...
                                    <div class="position-absolute top-0 end-0">
                                        <img src="{{ asset('asset/images/nexusflow-bg.svg') }}" width="500"/>
                                    ...
                                    <div
                                        ...
                                        <div class="text-left mx-5">
                                            <h2 class="text-white fw-medium lh-base text-capitalize mb-3">Let's Get <br/> Started
                                                With <br/> <h1 class="font-weight"><span class="text-warning">NexusFlow</span></h1> </h2>
                                        </div>
                                        ...
                                        <div class="text-center">
                                            <p class="text-white text-opacity-75 mb-0 mt-3">
                                                ...
                                                </script> &copy; NexusFlow developed by <a href="#"
                                                    class="text-white">Electro7 Technologies</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mb-0 border-0 shadow-none mb-0">
                                    <div class="card-body p-sm-5">
                                        <div class="text-center mt-5">
                                            <img src="{{ asset('asset/images/logos/vertical-logo-black.svg') }}" height="100"/>
                                            <br/><br/>
